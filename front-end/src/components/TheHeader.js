  ...
  return (
    ...
    >
      <div className="container md:flex md:flex-row-reverse md:justify-between md:items-center mt-4">
        ...
        {/* Hero Text */}
        <div className="text-center md:text-left mt-4 ml-8">
          <h1 className="text-white font-bold text-4xl md:text-5xl p-1">
            Empowering Your Health, Seamlessly
          </h1>
          <h3 className="text-white md:mr-10 font-normal text-base p-1 my-4">
            Access top-notch healthcare services, manage appointments, and stay
            connected with your doctor all in one place. Experience personalized
            care with our easy-to-use platform.
          </h3>
